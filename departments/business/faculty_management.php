...
// Load faculty list for Business
try {
...
<head>
  ...
  <title>Business Department - Manage Faculty</title>
  <link rel="stylesheet" href="../../styles.css">
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
  <style>
    :root { --dept-primary: #ea580c; --dept-secondary: #f97316; }
...
<body>
  <div class="dashboard">
    ...
    <div class="main-content">
      <div style="padding:20px; max-width:1200px; margin:0 auto;">
        <h1 style="margin:0 0 12px 0;">Manage Faculty - Business</h1>
  ...
  <script>
    async function fetchSubjects() {
      try { const r = await fetch(`../../api/subjects.php?department=Business`); const d = await r.json(); return (d && d.success && Array.isArray(d.data)) ? d.data : []; } catch { return []; }
    }
